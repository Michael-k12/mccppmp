<x-layouts.app :title="'BSHM Dashboard'">
    <style>
        body {
        ...
        .card-blue {
            background: linear-gradient(135deg,rgba(0, 0, 0, 0.62),rgb(255, 115, 0));
        }
    ...
    <div class="dashboard-section">
        ...
        <div class="header-flex">
            ...
            <div class="header-right">
                ...
                <img src="{{ asset('images/bshm.jpg') }}" alt="BSIT Logo" class="logo-img">
            </div>
        </div>
...
<div class="dashboard-card card-purple">
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgb(255, 123, 0)');
        gradient.addColorStop(1, 'rgb(182, 182, 182)');
