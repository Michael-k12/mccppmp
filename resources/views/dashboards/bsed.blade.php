<x-layouts.app :title="'BSED Dashboard'">
    <style>
        body {
        ...
        .card-blue {
            background: linear-gradient(135deg,rgb(184, 184, 184),rgb(255, 251, 0));
        }
    ...
    <div class="dashboard-section">
        ...
        <div class="header-flex">
            ...
            <div class="header-right">
                ...
                <img src="{{ asset('images/bsed.jpg') }}" alt="BSIT Logo" class="logo-img">
            </div>
        </div>
...
<div class="dashboard-card card-purple">
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgb(255, 238, 0)');
