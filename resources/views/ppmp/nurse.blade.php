<x-layouts.app :title="'NURSE'">
    <h1 class="text-2xl font-bold mb-4">Nurse Project Plan</h1>

    <!-- Filter Form -->
    <form method="GET" action="{{ route('ppmp.nurse') }}" class="mb-4 inline-block">
    ...
    <!-- Download Button -->
    <a href="{{ route('ppmp.nurse.download', ['year' => $selectedYear]) }}" class="download-btn">Download PDF</a>
    ...
    <div class="overflow-x-auto bg-white border border-gray-200 shadow rounded-lg mt-4">
        <table class="excel-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-gray-500 py-4">No NURSE PPMPs found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
