...
case 'LIBRARY':
    ...
    // Get available years for the department
    ...
    // Approved budgets per year for the department
...
// Always fetch the latest college-wide budget regardless of department
